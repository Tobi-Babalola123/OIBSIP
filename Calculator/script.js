document.addEventListener("DOMContentLoaded", () => {
  ...
  let currentInput = ""; // Holds the current input expression
  let lastResult = ""; // Stores the last result for the "ans" button
      ...
      switch (value) {
        ...
        case "√":
          ...
          try {
            ...
            resultField.textContent = "Error"; // Handle invalid input
            currentInput = "";
            lastResult = "";
          }
          break;
        ...
        default:
          currentInput += value; // Append the clicked button value to currentInput
          break;
      }

      updateDisplay(); // Update the input and result fields
    });
  });
});
